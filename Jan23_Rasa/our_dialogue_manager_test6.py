    ...
    for word in tokenized_msg:
        ...
        for item in predict:  # for each prediction text
            ...
            for intent,confi in item_intent_dis:
                ...
                #weight = 0.5
                #score = float(confi) * (1-weight) + sigmoid(utt_score) * (weight) # curiously, this results int empty tensor list in predict_with_score
                #score = sigmoid(float(confi) + utt_score) #TODO: why do this and the above line have this strange error?
